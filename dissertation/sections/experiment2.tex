...
\textit{We can conclude from this that rebooting the host systems between experimental runs would result in worse performance, thus in future experiments the host systems will not be rebooted between runs.}
